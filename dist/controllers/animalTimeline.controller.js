...
exports.getAnimalTimeline = getAnimalTimeline;
...
async function getAnimalTimeline(req, res) {
    try {
      ...
      `, {
        ...
        return res.status(http_status_codes_1.StatusCodes.OK).json((0, apiResponse_1.successResponse)({
            message: "Animal timeline fetched successfully",
            data: {
                animal: {
                    id: animal.get("id"),
...
async function getAnimalSummary(req, res) {
    try {
        const ranchId = req.ranch.id;
        const { animalId } = req.params;
        const rows = await models_1.sequelize.query(`
      ...
      `, {
        ...
        return res.status(http_status_codes_1.StatusCodes.OK).json((0, apiResponse_1.successResponse)({
            message: "Animal summary fetched successfully",
            data: {
                animal: {
                    id: row.animal_id,
