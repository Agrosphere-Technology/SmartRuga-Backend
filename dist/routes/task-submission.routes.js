...
const task_submission_controller_1 = require("../controllers/task-submission.controller");
 ...
 *         description: Task not found
 */
router.post("/:slug/tasks/:taskPublicId/submissions", (0, auth_1.requireAuth)(), (0, ranchAccess_1.requireRanchAccess)("slug"), upload_1.upload.single("image"), task_submission_controller_1.createTaskSubmission);
router.get("/:slug/tasks/:taskPublicId/submissions", (0, auth_1.requireAuth)(), (0, ranchAccess_1.requireRanchAccess)("slug"), task_submission_controller_1.listTaskSubmissions);
/**
 * @openapi
 ...
 */
router.patch("/:slug/tasks/:taskPublicId/submissions/:submissionPublicId/review", (0, auth_1.requireAuth)(), (0, ranchAccess_1.requireRanchAccess)("slug"), task_submission_controller_1.reviewTaskSubmission);
/**
 * @openapi
 ...
 *         description: Task or submission not found
 */
router.get("/:slug/tasks/:taskPublicId/submissions/:submissionPublicId", (0, auth_1.requireAuth)(), (0, ranchAccess_1.requireRanchAccess)("slug"), task_submission_controller_1.getTaskSubmissionByPublicId);
/**
 * @openapi
 ...
 *         description: Task or submission not found
 */
router.post("/:slug/tasks/:taskPublicId/submissions/:submissionPublicId/image", (0, auth_1.requireAuth)(), (0, ranchAccess_1.requireRanchAccess)("slug"), upload_1.upload.single("image"), task_submission_controller_1.uploadTaskSubmissionImage);
/**
 * @openapi
 * /api/v1/ranches/{slug}/tasks/{taskPublicId}/submissions/{submissionPublicId}/image:
 *   delete:
 ...
 *         description: Task or submission not found
 */
router.delete("/:slug/tasks/:taskPublicId/submissions/:submissionPublicId/image", (0, auth_1.requireAuth)(), (0, ranchAccess_1.requireRanchAccess)("slug"), task_submission_controller_1.removeTaskSubmissionImage);
